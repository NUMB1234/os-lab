...
void create_mapping(uint64 *pgtbl, uint64 va, uint64 pa, uint64 sz, int perm) {
    ...
    */
    ...
    for (int i = 0; i < cnt; i++) {
        vpn[2] = (va >> 30) & 0x1ff;
        base_addr[2] = (unsigned long)pgtbl - PA2VA_OFFSET;  
        // 根页表的物理地址
        ...
        vpn[1] = (va >> 21) & 0x1ff;
        //base_addr[1] = ppn[2] << 12;
        base_addr[1] = (unsigned long*)((pgtbl_entry[2] >> 10) << 12);
        ...
        vpn[0] = (va >> 12) & 0x1ff;
        //base_addr[0] = ppn[1] << 12;
        base_addr[0] = (unsigned long*)((pgtbl_entry[1] >> 10) << 12);
        ppn[0] = pa >> 12;
